...
<section class="hero hero--main logo-color logo-color-white">
  <div class="container">
    <div class="hero__wrapper flex row jscb">

      <div class="hero__info">
        <h1 class="white">404</h1>
        <p class="white"><?php echo __('Page Not Found', 'contovista'); ?></p>
      </div>
...
<section class="newsletter newsletter--footer flex row jcsb">
    <div class="newsletter__wrapper">
      ...
      <button class="btn show-newsletter">
        <?php the_field('footer_button_title', 'option'); ?>
      </button>  
    </div>
    <div class="newsletter__image">
      <img src="<?php the_field('newsletter_image', 'option'); ?>" alt="<?php the_field('newsletter_title', 'option'); ?>">
    </div>
  
  </section>
  
  <section class="footer footer--with-newsletter-section">
    <div class="container flex row">
      ...
      <div class="footer__wrapper footer__contact-us">
        ...
        <?php if( !$newsletter ) : ?>
          <button class="btn"><?php the_field('newsletter_button_text', 'option'); ?></button> 
        <?php endif; ?>
      </div>
      <div class="footer__wrapper footer__info">
        <span class="white"><?php the_field('brand_name', 'option'); ?></span>
  
        <a class="white" href="<?php the_field('link_to_google_maps', 'option'); ?>" target="_blanc"><?php the_field('address', 'option'); ?></a>
